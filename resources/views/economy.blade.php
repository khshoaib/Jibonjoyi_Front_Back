...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('frontend/assets/css/economy.css') }}" class="styles" />
        ...
        <main>
            ...
            <a href="#" class="bann">
                <img data-src="{{ asset('storage/' . $ad->vertical_ad1) }}"
                    src="data:image/gif;base64,R0lGODlhAQABAAAAACw=" class="js-img" alt="ad_img" />
            </a>
...
">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            const defaultButton = document.querySelector(".buttons button:nth-child(9)"); // Adjust if needed
            if (defaultButton) {
