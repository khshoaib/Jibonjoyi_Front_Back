...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('frontend/assets/css/history.css') }}" class="styles" />
...
">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            const defaultButton = document.querySelector(".buttons button:nth-child(1)"); // Adjust if needed
            if (defaultButton) {
